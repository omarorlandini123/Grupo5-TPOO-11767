...
{
    public partial class PantVistaEstudiantes : Form
    {
        // Cadena de conexión a tu base de datos
        string connectionString = "Server=localhost; Database=MonitoreoNotasTpoo; Integrated Security=True;";
        public PantVistaEstudiantes()
        {
            InitializeComponent();
        }

        private void txtbuscarCodigoEstudiante_TextChanged(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string codigoEstudiante = txtbuscarCodigoEstudiante.Text.Trim();
